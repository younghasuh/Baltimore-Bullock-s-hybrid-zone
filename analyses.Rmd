...
b1blk <- ggplot(compare1, aes(x = cat, y = B1, fill = sp)) +
  ...
  scale_fill_manual(values = pal1, name = "Species", 
                    limits = c("Bull", "Balt"), 
                    labels = c(expression(italic("Bullock's Oriole")), 
                               expression(italic("Baltimore Oriole")))) +
  scale_x_discrete(name = "Specimen type", 
                   limits = c("Bull_hist", "Bull_mod", "Balt_hist", "Balt_mod"), 
                   labels = c("Historic", "Contemporary","Historic", "Contemporary")) +
  theme(legend.text.align = 0) +
...
ggsave("Figure4_v2.png", plot=b1blk, width=220, height=125, units="mm", dpi=600, scale=T)
```
...
ggsave("Figure3_v2.png", plot=last_plot(), width=400, height=150, units="mm", dpi=600, scale=T)
```
...
ggsave("chromatic_contrast_v2.png", plot = last_plot(), width = 200, height = 80, 
       units = "mm", dpi = 300,  bg = "transparent")
```
